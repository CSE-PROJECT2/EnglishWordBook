...
public class WordValidator {
    ...
    private static final String SYLLABLE_ENGLISH_PATTERN = "^[a-zA-Z·\s]+$";
    private static final String VALID_ENGLISH_FORMAT_PATTERN = "^[a-zA-Z]+( [a-zA-Z]+)*$";
    private static final String PRONUNCIATION_PATTERN = "^[가-힣]+( [가-힣]+)*$";
    private static final String MEANING_PATTERN = "^[가-힣ㄱ-ㅎㅏ-ㅣ]+(ap\\s[가-힣ㄱ-ㅎㅏ-ㅣ]+)*$"; // 뜻이 한글만 들어가는지 확인
